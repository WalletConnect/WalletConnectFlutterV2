...
class RelayAuth implements IRelayAuth {
  ...
  Future<bool> verifyJWT(String jwt) async {
    ...
    // Check the header
    if (decoded.header.alg != JWTHeader.JWT_ALG || decoded.header.typ != JWTHeader.JWT_TYP) {
  ...
  String encodeIss(Uint8List publicKey) {
    ...
    final String multicodec = '$MULTICODEC_ED25519_BASE${base58.encode(Uint8List.fromList(header + publicKey))}';
    return <String>[
      DID_PREFIX,
      DID_METHOD,
      multicodec,
